...
import { pullRequestReviewRequestedCallback } from "./handlers/pull-request-review-requested.ts";
...
webhooks.on("pull_request.review_requested", pullRequestReviewRequestedCallback);
